...
const SidebarInset = forwardRef(({ className, ...props }, ref) => {
  return (
    <main
      ref={ref}
      className={cn(
        "relative flex min-h-full flex-1 flex-col bg-background/50",
...
const SidebarContent = forwardRef(({ className, ...props }, ref) => {
  return (
    <div
      ...
      className={cn(
        "flex min-h-0 flex-1 flex-col gap-2 overflow-auto win11Scroll group-data-[collapsible=icon]:overflow-hidden",
        className
      )}
      {...props}
    />
